...
printer.bold(True)
printer.print_with_breaks("Winter", line_length=16)
printer.bold(False)
printer.feed(1)
...
printer.normal_size()
printer.feed(1)
printer.print_with_breaks("Fuyu", line_length=32)
printer.normal_size()
printer.feed_rows(6)
printer.bold(True)
printer.print(f"Nov 07 - Feb 03\n")
printer.bold(False)
printer.feed(1)
...
printer.double_height_width()
printer.bold(True)
printer.print_with_breaks("Lesser cold", line_length=16)
printer.bold(False)
printer.feed(1)
printer.triple_height_width()
printer.print("小寒\n")
printer.normal_size()
printer.feed(1)
printer.print_with_breaks("Shōkan", line_length=32)
printer.normal_size()
printer.feed_rows(6)
printer.bold(True)
printer.print(f"Jan 05 - Jan 19\n")
printer.bold(False)
printer.feed(1)
