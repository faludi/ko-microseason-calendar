...
# # Season and mini-season TEST
# printer.center_justify()
# # printer.print('-------------------------------\n')
# printer.print('===============[●]=============\n')
# # printer.print('===============================\n')
# printer.bold(True)
# printer.print("Summer  夏  Natsu\n")
# printer.bold(False)
# printer.print(f"May 05 - Aug 07\n")
# printer.print('-------------------------------\n')
# printer.bold(True)
# printer.print('Beginning of summer 立夏 Rikka\n')
# printer.bold(False)
# printer.print(f"May 05 - May 20\n")
# # printer.feed(1)
# # printer.print('===============[●]=============\n')
# printer.print('===============================\n')
# # printer.print('-------------------------------\n')
...
# printer.bold(True)
# printer.print_with_breaks("Frogs start singing", line_length=16)
# printer.bold(False)
# printer.feed(1)
...
# printer.normal_size()
# printer.feed(1)
# printer.print_with_breaks("Kawazu hajimete naku", line_length=32)
# printer.normal_size()
# printer.feed_rows(6)
# printer.bold(True)
# printer.print(f"May 05 - May 09\n")
# printer.bold(False)
# printer.feed(1)
# printer.print('===============[●]=============\n')
...
# printer.print('===============================\n')
printer.bold(True)
printer.print('Lesser ripening 小満 Shōman\n')
printer.bold(False)
printer.print(f"May 21 - Aug 05\n")
# printer.feed(1)
# printer.print('===============[●]=============\n')
printer.print('===============================\n')
# printer.print('-------------------------------\n')
printer.double_height_width()
printer.bold(True)
printer.print_with_breaks("Silkworms eat mulberry leaves", line_length=16)
printer.bold(False)
printer.feed(1)
printer.triple_height_width()
printer.print("蚕起食桑\n")
printer.normal_size()
printer.feed(1)
printer.print_with_breaks("Kaiko okite kuwa o hamu", line_length=32)
printer.normal_size()
printer.feed_rows(6)
printer.bold(True)
printer.print(f"May 21 - May 25\n")
printer.bold(False)
printer.feed(1)
printer.print('===============[●]=============\n')
